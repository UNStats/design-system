...
title: Icon
status: Experimental
source: https://github.com/UNDataForum/design-system/blob/master/packages/components/src/icon.js
---

[`@undataforum/components`](/components) comes with the following social media
icons: [EmailIcon](/components/email-icon),
[GitHubIcon](/components/github-icon) and
[TwitterIcon](/components/twitter-icon). You can use this component to build
social media icons for other services.

This example shows how `TwitterIcon` was built using `Icon`:
