...
storiesOf("MarkdownParagraph", module)
  .addDecorator(story => <Box m={3}>{story()}</Box>)
  .add("default margin-bottom", () => (
    <div>
      <MarkdownParagraph>{firstParagraph}</MarkdownParagraph>
      <MarkdownParagraph>{secondParagraph}</MarkdownParagraph>
    </div>
  ))
  .add("custom margin-bottom", () => {
    return (
      <div>
        <MarkdownParagraph mb={5}>{firstParagraph}</MarkdownParagraph>
        <MarkdownParagraph>{secondParagraph}</MarkdownParagraph>
      </div>
    );
  });
